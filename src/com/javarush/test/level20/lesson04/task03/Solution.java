...
public class Solution implements Serializable {
    ...
    public static class Singleton implements Serializable {
        ...
        //Он вызывается на десериализованном объекте.
        // И возвращать он должен уже существующий экземпляр класса,
        // соответствующий внутреннему состоянию десериализованного объекта
