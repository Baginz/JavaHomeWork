...
public class Solution {
    ...
    protected synchronized void method1(String param1) { //no
    ...
    protected void method5(String param2) {new StringBuffer().append(param2).append(param2).append(param2);
    }

    public synchronized String method6(int param2) {  //no
