    ...
    public static void main(String[] args) throws Exception{
        ...
        if (args[0].equals("-c"))
        {
            synchronized (Solution.class)
            {
                ...
                {
                    if (args[i].equals("м"))
                        person = Person.createMale(args[i - 1], new SimpleDateFormat("dd/MM/yyyy").parse(args[i + 1]));
                    else if (args[i].equals("ж"))
                        person = Person.createFemale(args[i - 1], new SimpleDateFormat("dd/MM/yyyy").parse(args[i + 1]));
