...
public class Solution {
    public static void main(String [] args) throws IOException
    {
        ...
        String afterQuestionMark = url.substring(url.indexOf("?")+1);    // indexOf , substring c нуля отсчет
        String [] tokens = afterQuestionMark.split("(\\&+)|(\\?+)"); // сплит возврашает все разделенное указаным раздельно,
        ArrayList<String> objList = new ArrayList<String>();               // например указав пробел разделим на слова
